...
$config['lang_uri_abbr'] = array("en" => "english", "cs" => "czech");

/* ignore the default language */
$config['lang_ignore'] = TRUE;

/* redirect on invalid language abbreviation */
$config['lang_redirect_url'] = $config['base_url'].$config['index_page']."cs/error_404";  
...
|
*/
$config['encryption_key'] = 'fsefsefse58se4845f13es14f8se941vse8g6';
