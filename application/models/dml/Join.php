...
class Join
{
	...
	public function execute(\CI_DB_active_record $db, $tablePrefix = '', $refactoredTableName = null, $extraSelectPrefix = '')
	{
		 ...
		 */
		$targetTableInfo = Builder::loadTableInfo( $this->targetTableName );
		...
		$columns = Builder::prepareSelect( $columns, $targetTable, $AS_prefix );
	...
	protected function disableASPrefix()
	{
		$this->dontUseASPrefix = true;
		return $this;
	}
