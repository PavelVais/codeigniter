...
class CI_DB_active_record extends CI_DB_driver {
	...
	public function store_session()
	{
		return array(
			 ...
			 "select_no_esc" => $this->ar_no_escape
		);
	}
	
	public function restore_session($data)
	{
		$this->ar_where = $data['where'];
		$this->ar_select = $data['select'];
		$this->ar_no_escape = $data['select_no_esc'];
		return $this;
	}
}
